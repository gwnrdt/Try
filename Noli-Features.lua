...
if not c:FindFirstChild("Accessory (MeshPartAccessory)") then
	game:GetService("Players"):Chat("-gh 75133535004735")
end
...
local function align(Part0, Part1)
	Part0.CustomPhysicalProperties = PhysicalProperties.new(0.01, 0.01, 0.01, 0.01, 0.01)
